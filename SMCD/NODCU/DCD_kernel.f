...
C..   
      ...
      PARAMETER   (MAXISL=15, MAXNODE=500)
...
C assumed 40% runoff percolates into ground.  6/24/2014
             ...
             if (uplow(i).eq.1) then
                if (docregion(i).eq."L") gwrate=0.25 !GW_RATE(YR)
                if (docregion(i).eq."M") gwrate=0.30 !0.4
                if (docregion(i).eq."H") gwrate=0.35 !0.4
...
C               OPEN(FILE='junk1_2.txt',UNIT=53,STATUS='UNKNOWN')
            ELSE IF(IFLOW.EQ.2) THEN
               OPEN(FILE='junk2_1.txt',UNIT=52,STATUS='UNKNOWN')
C               OPEN(FILE='junk2_2.txt',UNIT=53,STATUS='UNKNOWN')
            ELSE
               OPEN(FILE='junk3_1.txt',UNIT=52,STATUS='UNKNOWN')
C               OPEN(FILE='junk3_2.txt',UNIT=53,STATUS='UNKNOWN')
            ENDIF
            WRITE(52,930)FLE
C            WRITE(53,930)FLE
 930        FORMAT(A120)
