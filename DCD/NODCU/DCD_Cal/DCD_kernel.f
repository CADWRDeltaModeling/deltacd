...
C12      INTEGER*2 AGUNIT
      REAL*4 AW,S,IIE,LRA,LRD,FI,FD,ID,ID1,ID2,D
      REAL*4 LRAM, LRDM
      REAL*4 TAID,TAD,TMDID,TMDD,TADID,TADD,NTMDID,NTMDD
      REAL*4 TCU,PREC,RO,CDNET,CDDNET
      REAL*4 TAF2CFS,WX,DIV,DIV1,DIV2,DRN,D2
